	...
	extends ReferenceBrush
{
	 ...
	 * @since 2022/02/09
	 */
	public ARGB8888Brush(int[] __pixels, int __offset, int __length,
		int __width, int __height, int __scanLen,
