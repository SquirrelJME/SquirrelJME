...
package cc.squirreljme.scritchui.uiform.callbacks;
	...
	extends ShelfCallback
{
	...
	void paint(@NotNull UIDrawableBracket __drawable,
		...
		@NotNull Object __buf, int __offset, @Nullable int[] __pal, int __sx,
		int __sy, @Range(from = 0, to = Integer.MAX_VALUE) int __sw,
