...
public enum InstallErrorCodes
{
	...
	@Api INVALID_NATIVE_LIBRARY,

	/** Payment information incorrect. */
	@Api INVALID_PAYMENT_INFO,

	/** The provider certificate is not valid. */
	@Api INVALID_PROVIDER_CERT,

	/** The signature is not valid. */
	@Api INVALID_SIGNATURE,
	...
	@Api JAD_SERVER_NOT_FOUND,

	/** JAR class file verification failed. */
	@Api JAR_CLASSES_VERIFICATION_FAILED,
	...
	@Api MISSING_PROVIDER_CERT,

	/** No suite name was specified. */
	@Api MISSING_SUITE_NAME,
