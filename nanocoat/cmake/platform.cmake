...
if(NOT DEFINED SQUIRRELJME_PLATFORM)
	...
	message(STATUS "Input Compiler: ${CMAKE_C_COMPILER}")

	get_filename_component(CMAKE_C_COMPILER_BASENAME
	...
	elseif(APPLE OR "${CMAKE_SYSTEM_NAME}" STREQUAL "Darwin")
		set(SQUIRRELJME_PLATFORM "macosx")
	...
	elseif("${CMAKE_C_COMPILER_BASENAME}" STREQUAL "sdcc" OR
		"${CMAKE_C_COMPILER_BASENAME}" STREQUAL "sdcc.exe")
		set(SQUIRRELJME_PLATFORM "sdcc")
...
# Mac OS X Desktop?
if(SQUIRRELJME_PLATFORM STREQUAL "macosx" AND
...
if("${SQUIRRELJME_PLATFORM}" STREQUAL "dos" OR
	...
	"${SQUIRRELJME_PLATFORM}" STREQUAL "sdcc" OR
...
if("${SQUIRRELJME_ARCH}" STREQUAL "ia16" OR
	...
	"${SQUIRRELJME_PLATFORM}" STREQUAL "wince"  OR
	"${SQUIRRELJME_PLATFORM}" STREQUAL "sdcc")
...
## FPIC?
if("${SQUIRRELJME_PLATFORM}" STREQUAL "sdcc")
