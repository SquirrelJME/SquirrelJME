...
#define SJME_WALK_CURRENT sjme_frame_frameStack
SJME_WALK_BEGIN(SJME_NVM_WALK_PSEUDO_FRAME_STACK)
	SJME_WS_JAVA_V(top, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_JAVA_V(front, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_JAVA_V(length, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_NORM_P(set, SJME_NVM_WALK_PSEUDO_VALUE_SET),
SJME_WALK_END();
#undef SJME_WALK_CURRENT

#define SJME_WALK_CURRENT sjme_frame_frameStacks
SJME_WALK_BEGIN(SJME_NVM_WALK_PSEUDO_FRAME_STACKS)
	SJME_WS_JAVA_V(storageClaim, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_ARRAY(stack,
		SJME_WS_NORM_V(stack, SJME_NVM_WALK_PSEUDO_FRAME_STACK)),
	SJME_WS_NORM_P(order, SJME_NVM_WALK_PSEUDO_JAVA_TYPE_ID),
	SJME_WS_JAVA_V(orderFront, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_JAVA_V(orderTop, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_JAVA_V(orderLength, SJME_JAVA_TYPE_ID_INTEGER),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
#define SJME_WALK_CURRENT sjme_nvm_class_annotationBase
SJME_WALK_BEGIN(SJME_NVM_WALK_PSEUDO_ANNOTATION)
	SJME_WS_NORM_P(className, SJME_NVM_STRUCT_STRING_POOL_STRING),
	SJME_WS_NORM_P(fieldName, SJME_NVM_STRUCT_STRING_POOL_STRING),
	SJME_WS_NORM_P(tag, SJME_NVM_WALK_PSEUDO_ANNOTATION_TAG),
	SJME_WS_NORM_P(refClass, SJME_NVM_STRUCT_STRING_POOL_STRING),
	SJME_WS_NORM_P(valueJava, SJME_NVM_WALK_PSEUDO_JAVA_VALUE),
	SJME_WS_NORM_P(valueString, SJME_NVM_STRUCT_STRING_POOL_STRING),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
SJME_WALK_BEGIN(SJME_NVM_WALK_PSEUDO_TASK_GLOBALS)
	...
	SJME_WS_ATOMIC(mainThread,
		SJME_WS_NORM_P(mainThread, SJME_NVM_STRUCT_BRACKET_VM_THREAD_INSTANCE)),
	SJME_WS_JAVA_V(noOptimize, SJME_BASIC_TYPE_ID_BOOLEAN),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
SJME_WALK_BEGIN(SJME_NVM_WALK_PSEUDO_THREAD_SUB_SCHEDULE)
	...
	SJME_WS_LIST_P(order,
		SJME_WS_NORM_P(order, SJME_NVM_STRUCT_BRACKET_VM_THREAD_INSTANCE)),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
SJME_WALK_BEGIN(SJME_NVM_STRUCT_ARRAY_INSTANCE)
	...
	SJME_WS_CUSTOM_V(e, SJME_NVM_WALK_PSEUDO_VALUE_SET, NULL),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
SJME_WALK_BEGIN(SJME_NVM_STRUCT_CLASS_INSTANCE)
	SJME_WS_NORM_V(object, SJME_NVM_STRUCT_OBJECT_INSTANCE),
	SJME_WS_NORM_P(fieldName, SJME_NVM_WALK_PSEUDO_CHAR_SEQ),
	SJME_WS_JAVA_V(fieldHash, SJME_JAVA_TYPE_ID_INTEGER),
...
SJME_WALK_BEGIN(SJME_NVM_STRUCT_CLASS_INFO)
	...
	SJME_WS_LIST_P(annotations,
		SJME_WS_NORM_P(annotations, SJME_NVM_WALK_PSEUDO_ANNOTATION)),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
#define SJME_WALK_CURRENT sjme_nvm_frameBase
SJME_WALK_BEGIN(SJME_NVM_STRUCT_FRAME)
	SJME_WS_NORM_V(common, SJME_NVM_WALK_PSEUDO_COMMON),
	SJME_WS_PHANTOM(inState,
		SJME_WS_NORM_P(inState, SJME_NVM_STRUCT_STATE)),
	SJME_WS_PHANTOM(inThread,
		SJME_WS_NORM_P(inThread, SJME_NVM_STRUCT_BRACKET_VM_THREAD_INSTANCE)),
	SJME_WS_PHANTOM(inTask,
		SJME_WS_NORM_P(inTask, SJME_NVM_STRUCT_TASK)),
	SJME_WS_PHANTOM(parent,
		SJME_WS_NORM_P(parent, SJME_NVM_STRUCT_FRAME)),
	SJME_WS_NORM_V(pc, SJME_NVM_WALK_PSEUDO_PC_ADDR),
	SJME_WS_NORM_P(inClass, SJME_NVM_STRUCT_CLASS_INSTANCE),
	SJME_WS_NORM_P(inMethod, SJME_NVM_STRUCT_METHOD_INFO),
	SJME_WS_NORM_P(pool, SJME_NVM_STRUCT_POOL),
	SJME_WS_NORM_P(inCode, SJME_NVM_STRUCT_CODE_INFO),
	SJME_WS_NORM_V(stack, SJME_NVM_WALK_PSEUDO_FRAME_STACKS),
	SJME_WS_NORM_P(instance, SJME_NVM_STRUCT_OBJECT_INSTANCE),
	SJME_WS_JAVA_V(lastPc, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_NORM_V(lastIv, SJME_NVM_WALK_PSEUDO_BYTE_CODE),
	SJME_WS_JAVA_V(id, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_PHANTOM(phantomTracePoint,
		SJME_WS_NORM_P(phantomTracePoint,
			SJME_NVM_STRUCT_BRACKET_TRACE_INSTANCE)),
	SJME_WS_JAVA_V(index, SJME_JAVA_TYPE_ID_INTEGER),
	SJME_WS_NORM_P(condition.function,
		SJME_NVM_WALK_PSEUDO_CONDITION_FUNCTION),
	SJME_WS_NORM_V(flags,
		SJME_NVM_WALK_PSEUDO_FRAME_FLAGS),
SJME_WALK_END();
#undef SJME_WALK_CURRENT
...
SJME_WALK_BEGIN(SJME_NVM_STRUCT_TASK)
	...
	SJME_WS_LIST_P(threads,
		SJME_WS_NORM_P(threads, SJME_NVM_STRUCT_BRACKET_VM_THREAD_INSTANCE)),
	SJME_WS_NORM_P(classLoader, SJME_NVM_STRUCT_VM_CLASS_LOADER),
...
SJME_WALK_BEGIN(SJME_NVM_STRUCT_BRACKET_VM_THREAD_INSTANCE)
	SJME_WS_NORM_V(object, SJME_NVM_STRUCT_OBJECT_INSTANCE),
	SJME_WS_PHANTOM(inState,
		SJME_WS_NORM_P(inState, SJME_NVM_STRUCT_STATE)),
	SJME_WS_PHANTOM(inTask,
	...
	SJME_WS_ATOMIC(nativeThread,
		SJME_WS_NORM_P(nativeThread, SJME_NVM_STRUCT_BRACKET_VM_THREAD_INSTANCE)),
...
static const sjme_nvm_walk_pseudoType sjme_nvm_walk_pseudoOnly[] =
{
	...
	SJME_NVM_WALK_PSEUDO_ANNOTATION_TAG,
...
const sjme_nvm_walk_stepSelect sjme_nvm_walk_select[] =
{
	...
	SJME_WALK_SELECT(sjme_frame_frameStack,
		SJME_NVM_WALK_PSEUDO_FRAME_STACK),
	SJME_WALK_SELECT(sjme_frame_frameStacks,
		SJME_NVM_WALK_PSEUDO_FRAME_STACKS),
	...
	SJME_WALK_SELECT(sjme_nvm_class_annotationBase,
		SJME_NVM_WALK_PSEUDO_ANNOTATION),
	...
	SJME_WALK_SELECT(sjme_nvm_frameBase, SJME_NVM_STRUCT_FRAME),
