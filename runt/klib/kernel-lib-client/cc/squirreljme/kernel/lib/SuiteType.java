...
public enum SuiteType
{
	...
	{
		// {@squirreljme.error AV0h Cannot have a zero or negative dependency
		// index.}
		if (__i <= 0)
			throw new IllegalArgumentException("AV0h");
		...
		throws InvalidSuiteException, NullPointerException
	{
		...
		// {@squirreljme.error AV0i Could not obtain the type of suite from
		// the input manifest.}
		throw new InvalidSuiteException("AV0i");
	}
}
