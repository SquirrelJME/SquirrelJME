 ...
 * @since 2017/12/28
 */
public final class SystemProgramInstallReport
{
	/** The program which was installed. */
	protected final SystemProgram program;
	 ...
	 * @since 2017/12/28
	 */
	public SystemProgramInstallReport(SystemProgram __p)
	 ...
	 * @since 2017/12/28
	 */
	public SystemProgramInstallReport(int __e, String __m)
	 ...
	 * @since 2017/12/28
	 */
	public final SystemProgram program()
	{
		return this.program;
	}
}
