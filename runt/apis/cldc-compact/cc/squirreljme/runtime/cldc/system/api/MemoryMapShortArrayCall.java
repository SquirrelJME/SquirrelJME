...
/**
 * Interface for {@link SystemFunction#MEMORY_MAP_SHORT_ARRAY}.
 *
 * @since 2018/03/14
 */
public interface MemoryMapShortArrayCall
	extends Call
{
	/**
	 ...
	 * @since 2018/03/14
	 */
	public abstract ShortArray memoryMapShortArray(long __a, int __l);
}
