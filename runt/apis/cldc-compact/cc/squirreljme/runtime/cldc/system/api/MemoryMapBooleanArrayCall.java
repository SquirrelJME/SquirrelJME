...
/**
 * Interface for {@link SystemFunction#MEMORY_MAP_BOOLEAN_ARRAY}.
 *
 * @since 2018/03/14
 */
public interface MemoryMapBooleanArrayCall
	extends Call
{
	/**
	 ...
	 * @since 2018/03/14
	 */
	public abstract BooleanArray memoryMapBooleanArray(long __a, int __l);
}
