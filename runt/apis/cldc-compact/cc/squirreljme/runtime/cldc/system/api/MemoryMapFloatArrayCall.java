...
/**
 * Interface for {@link SystemFunction#MEMORY_MAP_FLOAT_ARRAY}.
 *
 * @since 2018/03/14
 */
public interface MemoryMapFloatArrayCall
	extends Call
{
	/**
	 ...
	 * @since 2018/03/14
	 */
	public abstract FloatArray memoryMapFloatArray(long __a, int __l);
}
