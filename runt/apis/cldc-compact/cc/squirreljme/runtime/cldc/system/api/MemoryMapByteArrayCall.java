...
/**
 * Interface for {@link SystemFunction#MEMORY_MAP_BYTE_ARRAY}.
 *
 * @since 2018/03/14
 */
public interface MemoryMapByteArrayCall
	extends Call
{
	/**
	 ...
	 * @since 2018/03/14
	 */
	public abstract ByteArray memoryMapByteArray(long __a, int __l);
}
