...
/**
 * Interface for {@link SystemFunction#MEMORY_MAP_INTEGER_ARRAY}.
 *
 * @since 2018/03/14
 */
public interface MemoryMapIntegerArrayCall
	extends Call
{
	/**
	 ...
	 * @since 2018/03/14
	 */
	public abstract IntegerArray memoryMapIntegerArray(long __a, int __l);
}
