...
/**
 * Interface for {@link SystemFunction#MEMORY_MAP_STRING_ARRAY}.
 *
 * @since 2018/03/14
 */
public interface MemoryMapStringArrayCall
	extends Call
{
	/**
	 ...
	 * @since 2018/03/14
	 */
	public abstract StringArray memoryMapStringArray(long __a, int __l);
}
