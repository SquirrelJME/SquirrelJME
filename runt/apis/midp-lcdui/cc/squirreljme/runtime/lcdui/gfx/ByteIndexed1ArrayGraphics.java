...
/**
 * 1-bit indexed graphics.
 *
 * @since 2018/03/25
 */
public final class ByteIndexed1ArrayGraphics
	extends AbstractIndexedArrayGraphics
{
	 ...
	 * @since 2018/03/25
	 */
	public ByteIndexed1ArrayGraphics(byte[] __buf, int[] __pal,
		int __w, int __h, int __p, int __o, int __atx, int __aty)
		throws IllegalArgumentException, NullPointerException
	{
		super(__w, __h, __p, __o, __buf.length, 8, __atx, __aty, __pal, 2);
