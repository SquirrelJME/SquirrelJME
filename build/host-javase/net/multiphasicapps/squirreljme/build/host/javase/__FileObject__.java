	...
	implements JavaFileObject
{
	...
	protected final FileDirectory input;
	 ...
	 *
	 * @param __fm The owning file manager.
	 * @param __in The compiler input source.
	 * @param __s The file to represent.
	 * @throws NullPointerException On null arguments.
	 * @since 2016/09/19
	 */
	__FileObject__(__FileManager__ __fm, FileDirectory __in, String __s)
