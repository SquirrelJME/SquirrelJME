	...
	implements Runnable
{
	...
	public void run()
	{
		try
		{
			// {@squirreljme.error BM01 Compilation failed.}
			if (!this.task.call())
				throw new CompilationFailedException("BM01");
		}
		
		// {@squirreljme.error BM02 The compiler has failed.}
		catch (RuntimeException e)
		{
			throw new CompilerException("BM02", e);
		}
	}
}
