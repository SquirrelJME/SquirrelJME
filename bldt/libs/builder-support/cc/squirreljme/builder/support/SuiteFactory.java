	...
	implements Runnable
{
	...
	public SuiteFactory(String... __args)
	{
		...
		// {@squirreljme.error AU0m Expected command for suite operation.}
	...
	public void run()
	{
		...
		switch (command)
		{
			...
			case "install":
				...
				// {@squirreljme.error AU0p The specified suite command is not
