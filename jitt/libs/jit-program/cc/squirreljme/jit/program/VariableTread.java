...
public final class VariableTread
{
		...
		throws IllegalArgumentException, NullPointerException
	{
		...
		// {@squirreljme.error AK02 Negative number of variable slots in the
		// tread specified.}
		if (__n < 0)
	...
	DataValue __set(int __i, JavaType __t, InitializationKey __k)
		throws ParserException
	{
		// {@squirreljme.error AK03 Cannot set the given index because it
		// exceeds the limit of the tread. (The index to set; The limit of the
		// tread)}
		int limit = limit();
		if (__i < 0 || __i >= limit)
			throw new ParserException(String.format("AK03 %d %d", __i, limit));
