...
static const sjme_dataType testTypesNarrow[] = {
	...
	SJME_DATATYPE_FLOAT, SJME_DATATYPE_OBJECT, (const sjme_dataType)-1};

/** Mask for the test types. */
static const sjme_jint testTypesNarrowValue[] = {
	static_cast<sjme_jint>(0xFFFFFFCB), 0x0000CDCB,
	static_cast<sjme_jint>(0xFFFFCDCB), static_cast<sjme_jint>(MAGIC_NUMBER),
	static_cast<sjme_jint>(MAGIC_NUMBER), static_cast<sjme_jint>(MAGIC_NUMBER),
	-1};

/** Long test types. */
static const enum sjme_dataType testTypesWide[] = {
	SJME_DATATYPE_LONG, SJME_DATATYPE_DOUBLE, (const sjme_dataType)-1};
