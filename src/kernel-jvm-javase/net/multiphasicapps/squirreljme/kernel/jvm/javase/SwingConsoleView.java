		...
		throws NullPointerException
	{
		...
		switch (vk)
		{
			...
			case KeyEvent.VK_DEAD_SEMIVOICED_SOUND:
				return KeyChars.DEAD_SEMIVOICED_SOUND;
			case KeyEvent.VK_DEAD_TILDE:		return KeyChars.DEAD_TILDE;
			case KeyEvent.VK_DEAD_VOICED_SOUND:
				return KeyChars.DEAD_VOICED_SOUND;
			...
			case KeyEvent.VK_INPUT_METHOD_ON_OFF:
				return KeyChars.INPUT_METHOD_ON_OFF;
			case KeyEvent.VK_INSERT:			return KeyChars.INSERT;
			case KeyEvent.VK_JAPANESE_HIRAGANA:
				return KeyChars.JAPANESE_HIRAGANA;
			case KeyEvent.VK_JAPANESE_KATAKANA:
				return KeyChars.JAPANESE_KATAKANA;
			...
			case KeyEvent.VK_MULTIPLY:
				return KeyChars.NUMPAD_MULTIPLY;
			...
			case KeyEvent.VK_PREVIOUS_CANDIDATE:
				return KeyChars.PREVIOUS_CANDIDATE;
			...
			case KeyEvent.VK_ROMAN_CHARACTERS:
				return KeyChars.ROMAN_CHARACTERS;
