 ...
 * @since 2016/04/06
 */
public class JVMIllegalThreadStateException
	extends JVMEngineException
{
	 ...
	 * @since 2016/04/06
	 */
	public JVMIllegalThreadStateException()
	{
		super();
	}
	 ...
	 * @since 2016/04/06
	 */
	public JVMIllegalThreadStateException(String __msg)
	{
		super(__msg);
	}
	 ...
	 * @since 2016/04/06
	 */
	public JVMIllegalThreadStateException(String __msg, Throwable __c)
	{
		super(__msg, __c);
	}
	 ...
	 * @since 2016/04/06
	 */
	public JVMIllegalThreadStateException(Throwable __c)
	{
		super(__c);
	}
}
