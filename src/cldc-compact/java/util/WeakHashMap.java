	...
	implements Map<K, V>
{
	...
	{
		// {@squirreljme.error ZZ01 The initial capacity of the weak
	...
	{
		// {@squirreljme.error ZZ03 No map to copy data from was specified.}
		if (__a == null)
			throw new NullPointerException("ZZ03");
