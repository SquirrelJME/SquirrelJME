...
public enum NCIVersion
{
	...
	public static final NCIVersion MIN_VERSION =
		CLDC_1;
	
	/** The maximum supported version. */
	public static final NCIVersion MAX_VERSION =
		CLDC_8;
	 ...
	 * @since 2016/03/13
	 */
	private NCIVersion(int __vid, boolean __undef,
	 ...
	 * @since 2016/03/13
	 */
	public static NCIVersion findVersion(int __vid)
	{
		// Go through all values from last to first
		NCIVersion[] vers = values();
		int n = vers.length;
		for (int i = n - 1; i >= 0; i--)
