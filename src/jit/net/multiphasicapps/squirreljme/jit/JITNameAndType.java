 ...
 * @since 2016/08/14
 */
public final class JITNameAndType
{
	/** The member name. */
	 ...
	 * @since 2016/08/14
	 */
	JITNameAndType(IdentifierSymbol __n, MemberTypeSymbol __t)
	...
	{
		// Must be this class
		if (!(__o instanceof JITNameAndType))
			return false;
		
		// Check
		JITNameAndType o = (JITNameAndType)__o;
