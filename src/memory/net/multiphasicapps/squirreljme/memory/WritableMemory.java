...
public interface WritableMemory
{
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeBytes(long __addr, byte[] __v, int __o, int __l)
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeChar(long __addr, char __v)
		throws MemoryIOException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeChars(long __addr, char[] __v, int __o, int __l)
		throws IndexOutOfBoundsException, MemoryIOException,
			NullPointerException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeDouble(long __addr, double __v)
		throws MemoryIOException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeDoubles(long __addr, double[] __v, int __o,
		int __l)
		throws IndexOutOfBoundsException, MemoryIOException,
			NullPointerException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeFloat(long __addr, float __v)
		throws MemoryIOException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeFloats(long __addr, float[] __v, int __o,
		int __l)
		throws IndexOutOfBoundsException, MemoryIOException,
			NullPointerException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeInts(long __addr, int[] __v, int __o, int __l)
		throws IndexOutOfBoundsException, MemoryIOException,
			NullPointerException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeLongs(long __addr, long[] __v, int __o, int __l)
		throws IndexOutOfBoundsException, MemoryIOException,
			NullPointerException;
	 ...
	 * @since 2016/06/05
	 */
	public abstract void writeShorts(long __addr, short[] __v, int __o,
		int __l)
		throws IndexOutOfBoundsException, MemoryIOException,
			NullPointerException;
}
