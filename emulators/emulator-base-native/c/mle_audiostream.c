...
#define FORWARD_DESC_create \
	DESC_METHOD(DESC_AUDIOSTREAM, DESC_STRING DESC_INT DESC_INT \
	DESC_ARRAY(DESC_INT))
...
#define FORWARD_DESC_midiPort \
	DESC_METHOD(DESC_MIDIPORT, DESC_STRING DESC_INT DESC_INT)
...
FORWARD_IMPL(AudioStream, create,
	jobject, Object,
	FORWARD_IMPL_args(jstring name, jint format, jint rate, jarray channels),
...
FORWARD_IMPL(AudioStream, decoder,
	...
	FORWARD_IMPL_args(jstring urlFile, jstring mime, jint format,
		jint rate, jarray buf, jint off, jint len),
	FORWARD_IMPL_pass(urlFile, mime, format, rate, buf, off, len))
...
FORWARD_IMPL(AudioStream, midiPort,
	jobject, Object,
	FORWARD_IMPL_args(jstring mime, jint format, jint rate),
	FORWARD_IMPL_pass(mime, format, rate))
...
FORWARD_IMPL_VOID(AudioStream, register,
	FORWARD_IMPL_args(jobject stream, jobject renderer, jint format,
		jint rate),
	FORWARD_IMPL_pass(stream, renderer, format, rate))
