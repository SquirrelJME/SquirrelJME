...
#define FORWARD_CLASS "cc/squirreljme/jvm/mle/ObjectShelf"
#define FORWARD_CLASS_NAME ObjectShelf
#define FORWARD_NATIVE_CLASS OBJECTSHELF_CLASSNAME

#define FORWARD_DESC_arrayCopyZ DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_BOOLEAN) DESC_INT DESC_ARRAY(DESC_BOOLEAN) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyB DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_BYTE) DESC_INT DESC_ARRAY(DESC_BYTE) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyS DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_SHORT) DESC_INT DESC_ARRAY(DESC_SHORT) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyC DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_CHAR) DESC_INT DESC_ARRAY(DESC_CHAR) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyI DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_INT) DESC_INT DESC_ARRAY(DESC_INT) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyJ DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_LONG) DESC_INT DESC_ARRAY(DESC_LONG) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyF DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_FLOAT) DESC_INT DESC_ARRAY(DESC_FLOAT) \
	DESC_INT DESC_INT )
#define FORWARD_DESC_arrayCopyD DESC_METHOD(DESC_VOID,  \
	DESC_ARRAY(DESC_DOUBLE) DESC_INT DESC_ARRAY(DESC_DOUBLE) \
	DESC_INT DESC_INT )

#define FORWARD_DESC_arrayIntsToBytes DESC_METHOD(DESC_VOID,  \
