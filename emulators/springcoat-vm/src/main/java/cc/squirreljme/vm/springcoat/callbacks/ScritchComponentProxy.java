 ...
 * @since 2024/06/15
 */
public class ScritchComponentProxy
	extends ScritchBaseProxy<ScritchComponentInterface>
{
	/**
	 ...
	 * @since 2024/06/15
	 */
	public ScritchComponentProxy(SpringMachine __machine,
		ScritchComponentInterface __wrapped)
		throws NullPointerException
	{
		super(ScritchComponentInterface.class, __machine, __wrapped);
	}
