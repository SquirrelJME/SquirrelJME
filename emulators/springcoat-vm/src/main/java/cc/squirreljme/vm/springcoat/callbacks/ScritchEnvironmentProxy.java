 ...
 * @since 2024/06/15
 */
public class ScritchEnvironmentProxy
	extends ScritchBaseProxy<ScritchEnvironmentInterface>
{
	/**
	 ...
	 * @since 2024/06/15
	 */
	public ScritchEnvironmentProxy(SpringMachine __machine,
		ScritchEnvironmentInterface __wrapped)
		throws NullPointerException
	{
		super(ScritchEnvironmentInterface.class, __machine, __wrapped);
	}
