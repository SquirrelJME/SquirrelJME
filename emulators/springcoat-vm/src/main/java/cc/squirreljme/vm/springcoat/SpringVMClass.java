	...
	implements HasAccessibleFlags, SpringClass
{
	 ...
	 * @since 2018/07/21
	 */
	SpringVMClass(SpringClass __super, SpringClass[] __interfaces,
		...
		throws NullPointerException
	{
		...
		SpringField[] fieldLookup = (__super == null ?
			...
			Arrays.copyOf(__super.fieldLookup(), numFields));
		...
		if (__super != null)
		{
			SpringField[] supertable = __super.fieldTable();
	 ...
	 *
	 * @param __class The class to get the root of.
