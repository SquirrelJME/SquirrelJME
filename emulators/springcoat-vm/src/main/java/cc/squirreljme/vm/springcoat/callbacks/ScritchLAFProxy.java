 ...
 * @since 2024/06/15
 */
public class ScritchLAFProxy
	extends ScritchBaseProxy<ScritchLAFInterface>
{
	/**
	 ...
	 * @since 2024/06/15
	 */
	public ScritchLAFProxy(SpringMachine __machine,
		ScritchLAFInterface __wrapped)
		throws NullPointerException
	{
		super(ScritchLAFInterface.class, __machine, __wrapped);
	}
