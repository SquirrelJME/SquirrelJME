 ...
 * @since 2024/06/15
 */
public class ScritchPaintableProxy
	extends ScritchBaseProxy<ScritchPaintableInterface>
{
	/**
	 ...
	 * @since 2024/06/15
	 */
	public ScritchPaintableProxy(SpringMachine __machine,
		ScritchPaintableInterface __wrapped)
		throws NullPointerException
	{
		super(ScritchPaintableInterface.class, __machine, __wrapped);
	}
