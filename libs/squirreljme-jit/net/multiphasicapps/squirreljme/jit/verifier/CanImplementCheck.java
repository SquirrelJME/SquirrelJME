 ...
 * implement the specified target interface.
 *
 * @since 2017/09/01
 */
public final class CanImplementCheck
	implements VerificationCheck
{
	 ...
	 * @since 2017/09/01
	 */
	public CanImplementCheck(ClassName __s, ClassName __t)
	...
	{
		// Check
		if (!(__o instanceof CanImplementCheck))
			return false;
		
		CanImplementCheck o = (CanImplementCheck)__o;
	...
	public String toString()
	{
		...
		if (ref == null || null == (rv = ref.get()))
			this._string = new WeakReference<>((rv = String.format(
				"%s implements %s?", this.source, this.target)));
