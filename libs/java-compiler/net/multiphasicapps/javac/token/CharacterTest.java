...
public final class CharacterTest
{
	...
	public static boolean isIdentifierPart(char __c)
	{
		return (__c >= 0x0000 && __c < 0x0009) ||
			...
			(__c >= 0x0620 && __c < 0x066A) ||
			(__c >= 0x066E && __c < 0x06D4) ||
			(__c >= 0x06D5 && __c < 0x06DE) ||
			(__c >= 0x06DF && __c < 0x06E9) ||
			(__c >= 0x06EA && __c < 0x06FD) ||
			__c == 0x06FF ||
			(__c >= 0x070F && __c < 0x074B) ||
			(__c >= 0x074D && __c < 0x07B2) ||
			(__c >= 0x07C0 && __c < 0x07F6) ||
			__c == 0x07FA ||
			(__c >= 0x0800 && __c < 0x082E) ||
			(__c >= 0x0840 && __c < 0x085C) ||
			__c == 0x08A0 ||
			(__c >= 0x08A2 && __c < 0x08AD) ||
			(__c >= 0x08E4 && __c < 0x08FF) ||
			(__c >= 0x0900 && __c < 0x0964) ||
			...
			(__c >= 0x09BC && __c < 0x09C5) ||
			(__c >= 0x09C7 && __c < 0x09C9) ||
			(__c >= 0x09CB && __c < 0x09CF) ||
			__c == 0x09D7 ||
			(__c >= 0x09DC && __c < 0x09DE) ||
			(__c >= 0x09DF && __c < 0x09E4) ||
			(__c >= 0x09E6 && __c < 0x09F4) ||
			__c == 0x09FB ||
			...
			(__c >= 0x0ABC && __c < 0x0AC6) ||
			(__c >= 0x0AC7 && __c < 0x0ACA) ||
			(__c >= 0x0ACB && __c < 0x0ACE) ||
			__c == 0x0AD0 ||
			(__c >= 0x0AE0 && __c < 0x0AE4) ||
			...
			(__c >= 0x0D3D && __c < 0x0D45) ||
			(__c >= 0x0D46 && __c < 0x0D49) ||
			(__c >= 0x0D4A && __c < 0x0D4F) ||
			__c == 0x0D57 ||
			(__c >= 0x0D60 && __c < 0x0D64) ||
			...
			(__c >= 0x0E01 && __c < 0x0E3B) ||
			(__c >= 0x0E3F && __c < 0x0E4F) ||
			...
			(__c >= 0x0EAD && __c < 0x0EBA) ||
			(__c >= 0x0EBB && __c < 0x0EBE) ||
			...
			__c == 0x0F37 ||
			__c == 0x0F39 ||
			(__c >= 0x0F3E && __c < 0x0F48) ||
			(__c >= 0x0F49 && __c < 0x0F6D) ||
			(__c >= 0x0F71 && __c < 0x0F85) ||
			(__c >= 0x0F86 && __c < 0x0F98) ||
			(__c >= 0x0F99 && __c < 0x0FBD) ||
			__c == 0x0FC6 ||
			(__c >= 0x1000 && __c < 0x104A) ||
			(__c >= 0x1050 && __c < 0x109E) ||
			...
			(__c >= 0x2CEB && __c < 0x2CF4) ||
			(__c >= 0x2D00 && __c < 0x2D26) ||
			__c == 0x2D27 ||
			__c == 0x2D2D ||
			(__c >= 0x2D30 && __c < 0x2D68) ||
			__c == 0x2D6F ||
			(__c >= 0x2D7F && __c < 0x2D97) ||
